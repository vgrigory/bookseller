...
abstract class BaseBook extends BaseObject  implements Persistent {
	...
	public function setBooksellerId($v)
	{
		...
		if ($this->bookseller_id !== $v) {
			...
			$this->modifiedColumns[] = BookPeer::BOOKSELLER_ID;
		}
	...
	public function setRebate($v)
	{
		...
		if ($this->rebate !== $v || $this->isNew()) {
			$this->rebate = $v;
			$this->modifiedColumns[] = BookPeer::REBATE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->publisher = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->price = ($row[$startcol + 3] !== null) ? (double) $row[$startcol + 3] : null;
			$this->bookseller_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
			$this->rebate = ($row[$startcol + 5] !== null) ? (double) $row[$startcol + 5] : null;
			...
			return $startcol + 7; // 7 = BookPeer::NUM_COLUMNS - BookPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[2] => $this->getPublisher(),
			$keys[3] => $this->getPrice(),
			$keys[4] => $this->getBooksellerId(),
			$keys[5] => $this->getRebate(),
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(BookPeer::BOOKSELLER_ID)) $criteria->add(BookPeer::BOOKSELLER_ID, $this->bookseller_id);
		if ($this->isColumnModified(BookPeer::REBATE)) $criteria->add(BookPeer::REBATE, $this->rebate);
