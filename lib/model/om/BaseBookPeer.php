...
abstract class BaseBookPeer {
	...
	const BOOKSELLER_ID = 'book.BOOKSELLER_ID';

	/** the column name for the REBATE field */
	const REBATE = 'book.REBATE';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Title', 'Publisher', 'Price', 'BooksellerId', 'Rebate', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'title', 'publisher', 'price', 'booksellerId', 'rebate', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TITLE, self::PUBLISHER, self::PRICE, self::BOOKSELLER_ID, self::REBATE, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'title', 'publisher', 'price', 'bookseller_id', 'rebate', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Title' => 1, 'Publisher' => 2, 'Price' => 3, 'BooksellerId' => 4, 'Rebate' => 5, 'CreatedAt' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'title' => 1, 'publisher' => 2, 'price' => 3, 'booksellerId' => 4, 'rebate' => 5, 'createdAt' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TITLE => 1, self::PUBLISHER => 2, self::PRICE => 3, self::BOOKSELLER_ID => 4, self::REBATE => 5, self::CREATED_AT => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'title' => 1, 'publisher' => 2, 'price' => 3, 'bookseller_id' => 4, 'rebate' => 5, 'created_at' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(BookPeer::PUBLISHER);
		$criteria->addSelectColumn(BookPeer::PRICE);
		$criteria->addSelectColumn(BookPeer::BOOKSELLER_ID);
		$criteria->addSelectColumn(BookPeer::REBATE);
	...
	{
	  return array(array('title', 'price', 'bookseller_id'), array('title', 'publisher', 'bookseller_id'));
	}
